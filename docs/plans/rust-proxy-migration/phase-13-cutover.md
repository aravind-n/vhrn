...
- [ ] Status: Not started
- Depends on: [Phase 12](phase-12-qualification.md) complete and explicit user approval to perform cutover.
...
- `AGENTS.md`, the frozen contract's Stable delivery and runtime invariants, [`plan.md`](plan.md), and Phase 12
  evidence;
