...
- [ ] Status: Not started
- Depends on: both pre-flights approved in [`plan.md`](plan.md) and [Phase 1](phase-01-candidate-scaffold.md) complete.
...
3. Confirm every dependency named above is complete before editing.
4. Implement only this phase and stay within its editable paths and responsibility boundary.
5. Record concrete evidence and update this file's status; leave later phase files unchanged.
