...
- `vhrn install` and `vhrn uninstall` no longer create, update, or remove shell aliases. Run
  harnesses as `vhrn <harness>` or define a user-owned alias; aliases created by older releases
  are left untouched.
